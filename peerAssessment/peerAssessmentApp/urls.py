...
urlpatterns = [
    ...
    #path('view_courses/course_detail/<int:pk>', views.view_course_detail, name= 'view_course detail'),
    #url(r'^(?P<name>\b[A-Za-z]\w+\b)/$', views.view_course_detail, name="view_courses"),
